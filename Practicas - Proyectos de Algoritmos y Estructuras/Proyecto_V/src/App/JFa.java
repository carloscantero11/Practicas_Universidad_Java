...
public class JFa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Proyecto IV");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N
        jLabel1.setText("Algoritmos y Estructuras I");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 20))); // NOI18N
        jPanel1.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 17)); // NOI18N
        jLabel2.setText("Nombre");

        txtNombre.setFont(new java.awt.Font("Dialog", 0, 17)); // NOI18N
        ...
        txtApellido.setFont(new java.awt.Font("Dialog", 0, 17)); // NOI18N
        ...
        txtCedula.setFont(new java.awt.Font("Dialog", 0, 17)); // NOI18N
        ...
        txtCorreo.setFont(new java.awt.Font("Dialog", 0, 17)); // NOI18N
        ...
        btnLimpiar.setText("Eliminar Todo");
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        txtApellido.setText(Tabla.getValueAt(seleccion,1).toString());
        txtCedula.setText(Tabla.getValueAt(seleccion,2).toString());
        txtCorreo.setText(Tabla.getValueAt(seleccion,3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
